...
def main():
    ...
    savings_maturity = float(input("Enter months"))
    ...
    cd_interest = float(input("Enter annual interest rate in CD account (in %): ")) /100
    cd_maturity = int(input("Enter number of months the CD will mature: "))
